package com.barchart.pivotal;

/**
 * GitHub constants
 */
public interface PivotalConstants {
	...
	/** */
	String HOST_API = "www.pivotaltracker.com"; //$NON-NLS-1$
	/** */
	String HOST_DEFAULT = "www.pivotaltracker.com"; //$NON-NLS-1$
	...
	/** */
	String SEGMENT_V5_API = "/services/v5"; //$NON-NLS-1$
